...
plot.overall.trend(meltedSubset)
plot.boxplot(meltedSubset)
...
plot.overall.trend(meltedLikert)
plot.boxplot(meltedLikert)
```
...
plot.overall.trend(meltedBaseline)
plot.boxplot(meltedBaseline)
...
plot.overall.trend(meltedBaselinePct)
plot.boxplot(meltedBaselinePct)
...
plot.overall.trend(meltedBaselineLikert)
plot.boxplot(meltedBaselineLikert)
...
plot.overall.trend(meltedPctLikert)
plot.boxplot(meltedPctLikert)
